...
Config.logoname = "QBCoreV9"


Config.OpenSettings = {['weapon'] = true,['needhud'] = true , ['bankcash'] = true}
...
Config.mapshow = true -------- for always show set true

Config.speedtype = "kmh" --- "kmh" or "mph"

Config.hudd = {}
Config.hudd.weapon = true
Config.hudd.needhud = {['iconcolor'] = "#FFFFFF", ['textstate'] = true, ['progcolor'] = "#f3a84f", ['position'] = "right-center", ['style']= "normal", ['size'] = 1.0, ['hudstate'] = true}
Config.hudd.bankcash = {['iconcolor'] = "#FFFFFF", ['progcolor'] = "#f3a84f", ['position'] = "right-top", ['size'] = 1.0, ['hudstate'] = true}
Config.hudd.topmenu = {['logostate'] = true, ['onlinestate'] = true, ['timestate'] = true}
Config.hudd.vehmenu = {['iconcolor'] = "#FFFFFF", ['progcolor'] = "#f3a84f", ['position'] = "right-bottom", ['size'] = 1.0}
...
timefinish = function()
    print('you can write event when gang time finish or win')
end
