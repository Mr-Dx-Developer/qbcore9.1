...
RegisterServerEvent("qb-forgery:server:ForgeIDCard", function(citizenid, firstname, lastname, birthday, nationality)
    local src = source
...
RegisterServerEvent("qb-forgery:server:ForgeWeapon", function(firstname,lastname,birthday)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent("qb-forgery:server:ForgeLawyerpass", function(passid,firstname,lastname, citizenid)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
