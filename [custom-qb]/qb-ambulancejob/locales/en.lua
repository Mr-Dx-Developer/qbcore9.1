local Translations = {
    ...
    info = {
        ...
        wep_unknown = 'Unknown',
        respawn_txt = 'RESPAWN IN: ~b~%{deathtime}~s~ SECONDS',
        respawn_revive = 'HOLD [~r~E~s~] FOR %{holdtime} SECONDS TO RESPAWN FOR $~b~%{cost}~s~',
        bleed_out = 'YOU WILL BLEED OUT IN: ~b~%{time}~s~ SECONDS',
        bleed_out_help = 'YOU WILL BLEED OUT IN: ~b~%{time}~s~ SECONDS, YOU CAN BE HELPED',
