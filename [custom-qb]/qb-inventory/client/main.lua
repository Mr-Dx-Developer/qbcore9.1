...
local function CreateItemDrop(index)
    ...
    SetEntityCompletelyDisableCollision(Config.ItemDropObject, false, true)		
...
RegisterNetEvent('inventory:client:OpenInventory', function(PlayerAmmo, inventory, other)
    if not IsEntityDead(PlayerPedId()) then
        ...
        SendNUIMessage({
            ...
            -- newThirst = Player.PlayerData.metadata['thirst'],
            charhealth = GetEntityHealth(GetPlayerPed(-1))-100,
            chararmor = GetPedArmour(GetPlayerPed(-1)),
