...
QBConfig.MaxPlayers = GetConvarInt('sv_maxclients', 30) -- Gets max players from config file, default 48
QBConfig.DefaultSpawn = vector4(297.95, -587.53, 49.75, 71.92)
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 7.2 -- Rate at which hunger goes down.
QBConfig.Player.ThirstRate = 6.8 -- Rate at which thirst goes down.
...
QBConfig.Server.Discord = "discord.gg/qbcoreframework" -- Discord invite link
