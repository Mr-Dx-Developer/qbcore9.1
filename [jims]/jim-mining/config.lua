...
Config = {
	...
	Timings = { -- Time it takes to do things
		["Cracking"] = math.random(15000, 21500),
		["Washing"] = math.random(15000, 22000),
		["Panning"] = math.random(30000, 32000),
		["Pickaxe"] = math.random(20000, 25000),
		["Mining"] = math.random(20000, 25000),
		["Laser"] = math.random(15000, 20000),
