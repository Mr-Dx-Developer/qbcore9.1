Config.Languages = {
    ['pt'] = { -- Brazilian Portuguese 🇧🇷
     ...
     ['zhcn'] = { -- Chinese simplified
        ...
        ['infoupdate'] = "致谢 & 建议 🙏🏻",
        ['infoupdateav'] = "信息 (有更新)",
        ['infoupdateavtext'] = "已有新版本可用，请前往 ~y~https://github.com/TayMcKenzieNZ/dpemotes~w~ 获取最新版。",
        ['suggestions'] = "想提出建议？",
    ...
    ['zhtw'] = { -- Chinese Traditional
        ...
        ['infoupdate'] = "致謝 & 建議 🙏🏻",
        ['infoupdateav'] = "信息 (有更新)",
        ['infoupdateavtext'] = "已有新版本可用，請前往 ~y~https://github.com/TayMcKenzieNZ/dpemotes~w~ 獲取最新版。",
        ['suggestions'] = "想提出建議？",
    ...
    ['hu'] = { -- Hungarian 🇭🇺
        ...
        ['infoupdateavtext'] = "A frissítés elérhető, a legfrissebb verziót a következő címen tudod beszerezni ~y~https://github.com/TayMcKenzieNZ/dpemotes~w~",
	...
	['no'] = { -- Norwegian 🇳🇴
        ...
        ['infoupdateavtext'] = "En oppdatering er tilgjengelig, du finner den nyeste versjonen her: ~y~https://github.com/TayMcKenzieNZ/dpemotes~w~",
        ['suggestions'] = "Forslag?",
	...
	['fa'] = { -- persian 🇮🇷
        ...
        ['infoupdateavtext'] = "update jadid vojod darad baray daryaft ~y~https://github.com/TayMcKenzieNZ/dpemotes~w~",
    ...
    ['lk'] = { -- Sinhala 🇱🇰
        ...
        ['infoupdateavtext'] = "Update ekak tiyanawa, alutma update eka methanin ganna ~y~https://github.com/TayMcKenzieNZ/dpemotes~w~",
        ['suggestions'] = "Suggestions?",
        ['suggestionsinfo'] = "~r~TayMcKenzieNZ~s~ on FiveM forums for any feature/emote suggestions! ✉️",
    ...
    ['es'] = { -- Spanish 🇪🇸
        ...
        ['infoupdateavtext'] = "Hay una actualización disponible, para conseguir la ultima version ingrese a ~y~https://github.com/TayMcKenzieNZ/dpemotes~w~",
    ...
    ['tr'] = { -- Turkish 🇹🇷
        ...
        ['infoupdateavtext'] = "Bir güncelleme mevcuttur, en son sürümü şu adresten edinin ~y~https://github.com/TayMcKenzieNZ/dpemotes~w~",
